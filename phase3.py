...
def p_statement_do_while(p):
    ''' statement : DO block_statement WHILE '(' condition ')' ';' '''    
#    ll
#    vcount
# num_called = 0;
...
def p_statement_if(p):
    ''' statement : IF '(' condition ')' block_statement action1 else_if
                  | IF '(' condition ')' statement action1 else_if '''
