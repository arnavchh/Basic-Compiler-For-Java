...
def p_else_if_block(p):
    ''' else_if : ELSE IF '(' condition ')' block_statement action_if else_if
                | ELSE IF '(' condition ')' statement action_if else_if
                | ELSE block_statement action_else
                | ELSE statement action_else
                | '''
    # print("HEREEEEEEE")
    # global num_called
    # num_called+=1
...
def p_statement_if(p):
    ''' statement : IF '(' condition ')' block_statement action_if else_if
                  | IF '(' condition ')' statement action_if else_if '''
